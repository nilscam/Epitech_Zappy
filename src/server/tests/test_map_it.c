...
int	test_map_it(void)
{
	...
	if (!map)
		return (84);
	add_player_to_map_at(map, (point_t){1, 1}, "red", "Ash Ketchum");
	add_player_to_map_at(map, (point_t){0, 0}, "red", "Brock");
	add_player_to_map_at(map, (point_t){1, 1}, "red", "Misty Williams");
	add_player_to_map_at(map, (point_t){1, 1}, "blue", "Gary Oak");
	printf("all players:\n");
